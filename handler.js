                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            let wel = API('males', '/welcome2', {
                                ...
                                background: 'https://telegra.ph/file/c00a072bb31aa594bfece.jpg',
...
global.dfail = async (type, m, conn) => {
    let msg = {
        ...
        nsfw: `⚠️ NSFW tidak aktif, Silahkan chat admin grup untuk mengaktifkan fitur ini!`,
        rpg: `⚠️ RPG tidak aktif, Silahkan hubungi admin grup untuk mengaktifkan fitur ini!`,
        restrict: '⚠️ Fitur ini di *disable*!'
    }[type]
